            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4'>
                <Card className='col-span-1 lg:col-span-2 bg-white w-full relative overflow-hidden'>
                    ...
                    <CardContent>
                        <Text className='text-gray-700 text-base max-w-2xl leading-relaxed'>
                            Welcome to Play Afrique, where we deliver a unique
                            African experience grounded in rich history and
                            culture. At Play Afrique, we celebrate and support
                            African talents by providing a platform for
                            expression through art exhibitions, live music,
                            dance performances, folk plays, and pop-up markets.
                            Play Afrique&apos;s mission is to become a vibrant
                            hub for African cuisine, entertainment, fashion, and
                            arts. We invite visitors worldwide to immerse
                            themselves in Africa&apos;s authentic flavours and
                            rhythms. Our commitment extends beyond showcasing
                            the continent&apos;s culture to fostering the growth
                            of emerging start-ups within our community. Join us
                            in experiencing the true essence of Africa.
                        </Text>
                        <CardFooter />
                    </CardContent>
                </Card>
                ...
                <div className='h-full w-full col-span-1 lg:col-span-3 grid grid-cols-1 lg:grid-cols-2 gap-4'>
                    ...
                    <Card className='rounded-xl shadow-sm bg-white border'>
                        ...
                        <CardContent>
                            <Text className='text-gray-600'>
                                ...
                                exhibitions, and performances. We are dedicated
                                to promoting African culture, supporting
                                emerging artists and start-ups, and creating a
                                dynamic and inclusive community where creativity
                    ...
                    <Card className='rounded-xl shadow-sm bg-white border'>
                        ...
                        <CardContent>
                            <Text className='text-gray-600'>
                                To become the premier hub for celebrating and
                                experiencing the rich diversity of African
                                culture, arts, cuisine, and entertainment,
                                bringing the vibrant spirit of Africa to the
                                world while empowering and showcasing local
                                talents.
                            </Text>
                        </CardContent>
                        <CardFooter />
